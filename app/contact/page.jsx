...
const ContactPage = () => {
  ...
  const contactDetails = [
    ...
    },
    {
      icon: MapPin,
      label: "Warehouse",
      value: "Kalika Boutique, 1234 Kakkanad, Kochi, Kerala, 123456",
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 ${errors.name ? "border-red-300 bg-red-50" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 ${errors.email
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 resize-none ${errors.message
                      ? "border-red-300 bg-red-50"
                      : "border-gray-300"
                    }`}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md text-center">
              ...
              <p className="text-sm text-gray-500">
                Follow us for latest deals & offers
              </p>
            </div>
          </div>
        </div>
