  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto p-8 text-center">
        <Loader2
          size={64}
          className="mx-auto text-indigo-600 mb-4 animate-spin"
        />
          ...
          {wishlist.map((item) => (
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                >
                  <div
                    className="w-20 h-20 flex items-center justify-center rounded transition-all duration-500 border border-black/10"
                    style={{
                      backgroundColor: [
                        "#FDFBF7",
                        "#F8F5F0",
                  ...
                  >
                    <span className="text-xl font-serif opacity-20 select-none">
                      {item.name?.charAt(0)}
                    </span>
                  </div>
                </div>
